      ...
      <div className="bg-black text-white py-2 text-sm hidden md:block">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link to="/help" className="hover:text-[#ffb54a] transition-colors">Help</Link>
            <Link to="/track-order" className="hover:text-[#ffb54a] transition-colors">Track Order</Link>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:block">
                ...
                <div className="text-xs text-gray-500 tracking-wider">FIXING TOMORROW TODAY</div>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex flex-1 max-w-2xl mx-8">
              <form onSubmit={handleSearchSubmit} className="relative w-full">
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-black rounded-full flex items-center justify-center text-white hover:bg-[#ffb54a] transition-colors"
                >
          ...
          <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg border-t animate-slide-up">
            <div className="container mx-auto px-4 py-4">
              <nav className="flex flex-col gap-2">
                ...
                <Link to="/deals" className="py-3 px-4 hover:bg-gray-100 rounded-lg transition-colors">
                  Deals
                </Link>
                <Link to="/account" className="py-3 px-4 hover:bg-gray-100 rounded-lg transition-colors">
                  My Account
                </Link>
                <Link to="/wishlist" className="py-3 px-4 hover:bg-gray-100 rounded-lg transition-colors flex items-center justify-between">
                  Wishlist
                  {wishlistItems.length > 0 && (
