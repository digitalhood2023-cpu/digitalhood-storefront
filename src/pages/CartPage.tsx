        ...
        <div className="container mx-auto px-4">
          ...
          <div className="cart-content grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-dh-dark-gray mb-3">
              ...
              <button
                onClick={clearCart}
                className="text-dh-dark-gray hover:text-red-500 text-sm transition-colors"
              >
                Clear Cart
              </button>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-6 sticky top-24">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-dh-text-gray text-xs mt-2">
                    Try code: DIGITAL10
                  </p>
                </div>
