          ...
          return (
            <article key={order.id} className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm sm:p-4">
              ...
              <div className="mt-3 flex flex-wrap items-center justify-end gap-2 border-t border-slate-100 pt-3">
                {!state.closed && <Link to={buildAccountOrderSupportUrl(order)} className="rounded-lg px-3 py-2 text-xs font-bold text-slate-600 hover:bg-slate-50">Report issue</Link>}
